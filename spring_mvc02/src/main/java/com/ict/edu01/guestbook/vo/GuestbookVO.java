...
public class GuestbookVO {
	...
	private String gb2_old_f_name;
	

	public String getGb2_old_f_name() {
		return gb2_old_f_name;
	}

	public void setGb2_old_f_name(String gb2_old_f_name) {
		this.gb2_old_f_name = gb2_old_f_name;
	}
