package com.ict.edu01.scheduler;
...
public class CommonScheduler {
	...
	// 주기적으로 실행 서비스를 autowired 하자
	@Autowired
	private GuestbookService guestbookService;
	
	// guestbook의 크기를 10초마다 갱신하자
	// @Scheduled(cron = "*/10 * * * * *")
	/*
	 * public void schedulerTest() { System.out.println("스케쥴러가 10초마다 실행됩니다");
	 * List<GuestbookVO> list = guestbookService.getGuestbookList();
	 * System.out.println("list의 크기는 : "+list.size()); System.out.println(); }
	 */
