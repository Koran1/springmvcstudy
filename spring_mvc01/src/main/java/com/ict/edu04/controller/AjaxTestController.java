...
// Controller 는 servlet-context.xml 로 리턴 
// RestController 는 리턴하지 않고 브라우저에 출력
//	=> 반환형이 String 인 경우 문서 타입이 contentType="text/html" 로 변경시키자
...
public class AjaxTestController {
	...
	public String Xml_Exam03() {
		...
		try {
	        ...
	        urlBuilder.append("?" + URLEncoder.encode("serviceKey","UTF-8") + "=Phsud7RN2nkw6wPmg2Fa7q%2BQZbDH%2Bnpp3W8%2F4SPFFTtGDYQFO89qKkyqQwLKFEV9cBRvLktzL3E0TueDq3%2B2bw%3D%3D"); 	/*Service Key (Encoding) = GET*/
	        //urlBuilder.append("?" + URLEncoder.encode("serviceKey","UTF-8") + "=Phsud7RN2nkw6wPmg2Fa7q+QZbDH+npp3W8/4SPFFTtGDYQFO89qKkyqQwLKFEV9cBRvLktzL3E0TueDq3+2bw=="); 	/*Service Key (Decoding) = POST*/
	        ...
	        // System.out.println("Response code: " + conn.getResponseCode());			// 200 이 정상적인 통신 성공
	...
	@RequestMapping(value="/test1017", produces="text/xml; charset=utf-8")
	@ResponseBody
	public String Xml_Test() {
		...
		try {
	        ...
	        urlBuilder.append("&" + URLEncoder.encode("base_date","UTF-8") + "=" + URLEncoder.encode("20241024", "UTF-8")); /*‘21년 6월 28일발표*/
	        urlBuilder.append("&" + URLEncoder.encode("base_time","UTF-8") + "=" + URLEncoder.encode("0500", "UTF-8")); /*05시 발표*/
	        urlBuilder.append("&" + URLEncoder.encode("nx","UTF-8") + "=" + URLEncoder.encode("55", "UTF-8")); /*예보지점의 X 좌표값*/
	        urlBuilder.append("&" + URLEncoder.encode("ny","UTF-8") + "=" + URLEncoder.encode("127", "UTF-8")); /*예보지점의 Y 좌표값*/ /*시도 이름(전국, 서울, 부산, 대구, 인천, 광주, 대전, 울산, 경기, 강원, 충북, 충남, 전북, 전남, 경북, 경남, 제주, 세종)*/
	        URL url = new URL(urlBuilder.toString());
	        conn = (HttpURLConnection) url.openConnection();
	        conn.setRequestMethod("GET");
	...
	@RequestMapping(value="/test05", produces="text/json; charset=utf-8")
	@ResponseBody
	...
	@RequestMapping(value="/test06", produces="text/json; charset=utf-8")
	@ResponseBody
	...
	@RequestMapping(value="/test1024", produces="text/json; charset=utf-8")
	@ResponseBody
	public String Json_Exam03() {
		...
		try {
	        ...
	        urlBuilder.append("&" + URLEncoder.encode("base_date","UTF-8") + "=" + URLEncoder.encode("20241025", "UTF-8")); /*‘21년 6월 28일발표*/
	        urlBuilder.append("&" + URLEncoder.encode("base_time","UTF-8") + "=" + URLEncoder.encode("0200", "UTF-8")); /*05시 발표*/
	        urlBuilder.append("&" + URLEncoder.encode("nx","UTF-8") + "=" + URLEncoder.encode("55", "UTF-8")); /*예보지점의 X 좌표값*/
	        urlBuilder.append("&" + URLEncoder.encode("ny","UTF-8") + "=" + URLEncoder.encode("127", "UTF-8")); /*-일 2회(06:00,18:00)회 생성 되며 발표시각을 입력- YYYYMMDD0600(1800) 최근 24시간 자료만 제공*/
	        URL url = new URL(urlBuilder.toString());
	...
	@RequestMapping(value="/db_join", produces="text/json; charset=utf-8")
	@ResponseBody
	public String DB_Join() {
		StringBuffer sb = new StringBuffer();
